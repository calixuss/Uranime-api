...
function getUserById(res, id, includeLibrary,User){
...
function getUserLibrary(res, id, Client){
  var sql = "SELECT ue.user_id as user_id, "+
    ...
    Client.query(sql, null, {raw:true}, [id]).success(function(result){
...
exports.getLibrary = function(req, res){
  ...
  getUserLibrary(res, userid,Client);
};
